...
if __name__ == "__main__":
    dirData = '/work/chall6/data/'
    dirOutput = '/work/chall6/output/'

    output = OutputClass()
    output.ReadData(dirData + 'Server1', dirOutput + 'Server1/')
    output.ReadData(dirData + 'Server2', dirOutput + 'Server2/')
    output.ReadData(dirData + 'Server3', dirOutput + 'Server3/')
    output.ReadData(dirData + 'Server4', dirOutput + 'Server4/')